...
featureCounts. The 44-sample cohort, rRNA exclusion list, placement filter,
...
Test diet, infection, and diet-by-infection effects with the 44-sample cohort.
:::
::: {.walkthrough-step}
...
This is the analysis-cohort, main-chromosome version of the interaction model.
It keeps every valid library after excluding QC outlier 1044.
