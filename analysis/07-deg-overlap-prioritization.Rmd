...
This page compares significant DEG lists from the model pages. It also runs the
...
required <- c("DESeq2", "ggplot2", "UpSetR", "ggVennDiagram")
...
run_treatment_diet_degs <- function(treatment_label) {
  ...
  keep_genes <- rowSums(counts_sub) >= params$min_total_count
