...
figure3_lollipop_png <- copy_publication_asset(
  figure3_lollipop_source,
  "figure3_expression_cluster_gene_level_GO_KEGG_lollipop_eukaryote_inclusive"
)
figure3_insect_png <- copy_publication_asset(
  figure3_insect_source,
...
figure3_exports <- data.frame(
  figure = c(
    "Figure 3 eukaryote-inclusive KEGG pathway illustration",
    "Figure 3 eukaryote-inclusive KEGG lollipop alternative",
    "Figure 3 insect-focused KEGG composite",
    "Figure 3 reference-context companion"
  ),
  source = basename(c(
    figure3_composite_source,
    figure3_lollipop_source,
  ...
  copied_to = basename(c(
    figure3_png,
    figure3_lollipop_png,
    figure3_insect_png,
    figure3_reference_png
  )),
  present = file.exists(c(
    figure3_png,
    figure3_lollipop_png,
