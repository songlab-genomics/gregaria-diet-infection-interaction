...
group, black crosses mark centroids, and arrows show the shift from control to
infected samples within each diet.
...
p_pca <- ggplot2::ggplot() +
  ...
  ggplot2::labs(
    title = "Fat body VST PCA with centroid shifts",
