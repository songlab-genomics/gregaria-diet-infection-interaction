---
title: "All samples + all scaffolds: DEG overlap and prioritization"
...
params:
  ...
  alpha: 0.05
  lfc_threshold: 1
  output_tag: "all-scaffolds-deg-overlap-prioritization"
---

## Purpose

This page compares significant DEG lists from the all-samples, all-scaffold
model pages. All 44 samples and every expression-filtered non-rRNA host locus
from the fresh competitive mapping are retained. It also runs the
...
```{r find-files}
current_run_dirs <- c(
  latest_dir("^all-scaffolds-deseq2-interaction-model_"),
  latest_dir("^all-scaffolds-diet-pairwise-deg_All_"),
  latest_dir("^all-scaffolds-infection-within-diet-deg_")
)
...
# This matrix was generated by the fresh competitive-host workflow after the
# project rRNA exclusion list was applied. No assembly-placement class is
