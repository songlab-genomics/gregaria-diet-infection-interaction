---
title: "Exon-only sensitivity analysis"
...
params:
  ...
  cluster_assignments: "output/rmd_runs/exon-only-cluster-enrichment_20260811-121306/full_heatmap_expression_cluster_assignments.csv"
...
### Exon-only drill-down

This overview is the canonical exon-only sensitivity page. Detailed notebooks
remain available for the [interaction model](37-exon-only-interaction-model.html),
[diet contrasts](38-exon-only-diet-pairwise-deg.html), [infection contrasts](39-exon-only-infection-within-diet-deg.html),
[DEG overlap](40-exon-only-deg-overlap.html), [searchable
catalogue](41-exon-only-deg-catalogue.html), [GO and KEGG
enrichment](42-exon-only-go-term-enrichment.html), [term-to-gene
index](43-exon-only-enrichment-term-gene-index.html), [expression
clusters](44-exon-only-expression-clusters.html), [curated target
genes](45-exon-only-curated-target-genes.html), and [figure
exports](46-exon-only-publication-figures.html). These pages document the
sensitivity branch without duplicating it in the main navigation.
