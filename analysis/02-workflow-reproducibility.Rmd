...
the *Schistocerca piceifrons* reference and which part tests diet, infection,
...
workflow_nodes <- data.frame(
  ...
  detail = c(
    ...
    "mapping summaries", "per-sample count files",
...
The important handoff for this repository is the count matrix. The original
STAR alignment and gene-counting steps produce per-sample count files; the
workflowR pages then merge and check those counts, remove the loci listed in
