...
Both count definitions use the same 45 libraries and corrected metadata:
`1024` is infected diet 33, while the recovered `1044` library is infected
diet 83. The two branches differ only in which annotation feature types are
counted, so their DEG results can be compared directly.
