---
title: "Exon-only diet pairwise DEGs"
...
params:
  ...
  alpha: 0.05
  lfc_threshold: 1
  output_tag: "exon-only-diet-pairwise-deg"
---

## Purpose

This page reruns the diet contrasts with exon-only counts while retaining the
same 45 samples, rRNA exclusion, main-chromosome scope, DESeq2 filtering, and
contrast directions used in the primary analysis.
...
library in `mehreen_metadata_corrected_45.txt`, including the samples currently treated
