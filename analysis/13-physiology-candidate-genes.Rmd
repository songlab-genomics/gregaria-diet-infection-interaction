...
This page tests the biological hypothesis in a targeted way using all 45 samples.
Instead of starting
...
The all-scaffold and placed-chromosome models use the same 45 samples and the
...
p_candidate <- ggplot2::ggplot(
  ...
  ggplot2::labs(
    ...
    subtitle = "All 45 samples retained; panels differ only in the tested gene universe",
