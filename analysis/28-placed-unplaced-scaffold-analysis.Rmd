...
params:
  ...
  host_only_counts: "data/derived/counts/transcript_exon_host_only_host_counts_no_rrna.tsv.gz"
  ...
  placement: "data/derived/mapping/host_gene_sequence_placement.tsv.gz"
  previous_fresh_results: "data/derived/deseq2/transcript_exon_primary_all_contrasts.csv.gz"
  cluster_assignments: "data/derived/analysis_inputs/transcript_exon_cluster_assignments.csv"
  homology_evidence: "data/derived/analysis_inputs/corrected_gene_homology_evidence.tsv"
  alpha: 0.05
  lfc_threshold: 1
  min_count: 10
  min_samples: 3
