...
output:
  workflowr::wflow_html:
    ...
    toc_float: true
params:
  primary_counts: "output/runs/host_pathogen_dual_corrected45_20260809-153146/04-count-matrices/competitive-host/host_transcript_exon_counts.tsv"
  host_only_counts: "output/runs/host_pathogen_dual_corrected45_20260809-153146/04-count-matrices/host-only/host_transcript_exon_counts.tsv"
  metadata: "data/metadata/mehreen_metadata_corrected_45.txt"
  ...
  previous_fresh_results: "output/rmd_runs/transcript-exon-primary-corrected45_20260809-153146/host_deseq2_all_contrasts.csv"
...
Run matched all-sample DESeq2 analyses for the full and conservative gene universes.
:::
::: {.walkthrough-step}
...
All 45 sequenced samples are retained. No sample is classified or removed as an
...
placed_deg_barplot <- ggplot2::ggplot(
  ...
  ggplot2::labs(
    ...
    subtitle = paste0("Competitive host mapping; all 45 samples; padj < ", alpha, "; |log2FC| >= ", lfc_threshold),
...
> factors estimated from the placed host-gene matrix. All 45 sequenced samples
