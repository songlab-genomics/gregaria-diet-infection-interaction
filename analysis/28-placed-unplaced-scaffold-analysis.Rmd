---
title: "Placed-scaffold primary analysis and unplaced-gene sensitivity"
...
output:
  workflowr::wflow_html:
    ...
    toc_float: true
params:
  primary_counts: "output/runs/host_pathogen_dual_20260727_000952/04-count-matrices/competitive-host/host_exon_counts.tsv"
  host_only_counts: "output/runs/host_pathogen_dual_20260727_000952/04-count-matrices/host-only/host_exon_counts.tsv"
  metadata: "data/metadata/mehreen_metadata_fixed.txt"
  ...
  previous_fresh_results: "output/runs/host_pathogen_dual_20260727_000952/local-analysis/host-mapping-audit_20260729-163928/unified-model/competitive-host/host_deseq2_all_contrasts.csv"
...
All 44 sequenced samples are retained. No sample is classified or removed as an
outlier in this analysis. Annotated rRNA loci are removed before modeling.
...
placed_deg_barplot <- ggplot2::ggplot(
  ...
  ggplot2::labs(
    ...
    subtitle = paste0("Competitive host mapping; all 44 samples; padj < ", alpha, "; |log2FC| >= ", lfc_threshold),
...
placed_pca_plot <- ggplot2::ggplot(
  ...
  ggplot2::labs(
    ...
    subtitle = "Competitive mapping; all samples retained; crosses mark condition centroids",
...
> factors estimated from the placed host-gene matrix. All 44 sequenced samples
...
`manuscript_within_diet_deg_count_update.tsv` after collaborator approval.
