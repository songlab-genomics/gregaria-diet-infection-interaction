...
output:
  workflowr::wflow_html:
    ...
    toc_float: true
params:
  exon_counts_file: "output/runs/host_pathogen_dual_corrected45_20260809-153146/04-count-matrices/competitive-host/host_exon_counts.tsv"
  transcript_exon_counts_file: "output/runs/host_pathogen_dual_corrected45_20260809-153146/04-count-matrices/competitive-host/host_transcript_exon_counts.tsv"
...
Retain all 45 samples, the competitive host alignment, the same chromosome
...
p_deg_counts <- ggplot2::ggplot(
  ...
  ggplot2::labs(
    ...
    subtitle = paste0(
      "All 45 samples; nuclear chromosomes; rRNA removed; padj < ",
...
p_lrt <- lrt_summary |>
  ...
  ggplot2::labs(
    ...
    subtitle = "Omnibus LRT, Benjamini-Hochberg FDR < 0.05; all 45 libraries retained",
    x = NULL,
