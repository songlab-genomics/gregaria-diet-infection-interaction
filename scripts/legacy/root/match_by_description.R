...
# WRITE OUTPUT
# ---------------------------
write_csv(output, "data/legacy_csv/overlap_helpers/collapsed_GeneIDs_filtered.csv")

cat("Done! Output written to data/legacy_csv/overlap_helpers/collapsed_GeneIDs_filtered.csv\n")
