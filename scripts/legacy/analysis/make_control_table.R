...
file_50 <- file.path(outDir, "DEG_ControlOnly_DietEffects_SVA/33_vs_50/SIG_33_vs_50_no_rRNA.csv")
file_83 <- file.path(outDir, "DEG_ControlOnly_DietEffects_SVA/33_vs_83/SIG_33_vs_83_no_rRNA.csv")
...
write.csv(
  final_table,
  file.path(outDir, "Diet_50_83_Combined_Annotated.csv"),
  row.names = FALSE
)
